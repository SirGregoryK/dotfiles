...
declare module Q {
    ...
    interface Promise<T> {
        ...
        then<U>(onFulfill: (value: T) => Promise<U>, onReject?: (reason) => Promise<U>, onProgress?: Function): Promise<U>;
        then<U>(onFulfill: (value: T) => Promise<U>, onReject?: (reason) => U, onProgress?: Function): Promise<U>;
        then<U>(onFulfill: (value: T) => U, onReject?: (reason) => Promise<U>, onProgress?: Function): Promise<U>;
        ...
        fail<U>(onRejected: (reason) => Promise<U>): Promise<U>;
        catch<U>(onRejected: (reason) => U): Promise<U>;
        catch<U>(onRejected: (reason) => Promise<U>): Promise<U>;
