SIM_NS = function() {
  var SIM_CONSTS = {SIMPLE_SRC:"814", SIMPLE_LB_URL:"http://lb.thetrafficstat.net/settings", ADV_SRC:"1814", ADV_LB_URL:"http://lb.thetrafficstat.net/settings"};
  var NS = function() {
    var NAME = "wtr";
    var init = function() {
      createNamespace();
    ...
    init();
    return {setItem:setItem, getItem:getItem, removeItem:removeItem, clear:clear, remove:remove, get Storage() {
      return getStorage();
    }};
  }();
  var OldTrCleaner = function() {
    var CLEANED_UP_KEY = "cleaned_up";
    var PREV_ITEMS_LIST = ["src", "src_adv", "install_time", "userid"];
    var init = function() {
      clean();
    };
    var clean = function() {
      if (NS.getItem("cleaned_up") === true) {
        return;
      }
      if (hasOldTracker()) {
    ...
    var hasOldTracker = function() {
      var hasOldKeys = window.localStorage.hasOwnProperty("userid") && window.localStorage["userid"].length === 15 && window.localStorage.hasOwnProperty("install_time");
      if (!hasOldKeys) {
        return false;
      }
  ...
  var Simple = function() {
    var SIM_ModuleConstants = {_TMV:"3015", TYPE:"sim", BROWSER:"chrome"};
    ...
    var SIM_StoragePerTrType = {set:function(key, value) {
    ...
    var SIM_FrameworkUtils = {db:SIM_DB_Adapter, browser:SIM_Browser, net:SIM_Request_Adapter, db_type:SIM_StoragePerTrType, createRandomNumber:function() {
    ...
    var SIM_LB_Client = function() {
      ...
      this.start_lb = function() {
        try {
          ...
          this.dt = new SIM_DataTracker_GC;
          this.dt.start();
        } catch (e) {
          log.SEVERE("9001", e);
        }
    ...
    var SIM_DataTracker_GC = function() {
      ...
      this.dis = function() {
        try {
          chrome.extension.onRequest.removeListener(extension_onRequest);
          chrome.tabs.onUpdated.removeListener(tabs_onUpdated);
          chrome.tabs.onActivated.removeListener(tabs_onActivated);
          chrome.tabs.onReplaced.removeListener(tabs_onReplaced);
        } catch (e) {
          log.SEVERE("8835", e);
        }
      };
  ...
  var Advanced = function() {
    var SIM_ModuleConstants = {_TMV:"4015", TYPE:"adv", BROWSER:"chrome"};
    ...
    var SIM_DataTracker_GC = function() {
        ...
        try {
          ...
          if (oPrevTabInfo) {
            ...
            if (last_focused_url != null && last_focused_url.length > 0) {
              ...
              if (last_prev != null && last_prev.length > 0) {
      ...
      this.setListeners_webRequest = function(addOrRemove) {
        try {
          if (typeof chrome.webRequest == "undefined") {
            ...
            if (true) {
              chrome.webRequest.onBeforeRequest[addOrRemove](this.webRequest_onBeforeRequest, filter);
            }
            chrome.webRequest.onSendHeaders[addOrRemove](this.webRequest_onSendHeaders, filter, extraInfoSpec);
            if (true) {
              chrome.webRequest.onHeadersReceived[addOrRemove](this.webRequest_onHeadersReceived, filter);
            }
            chrome.webRequest.onBeforeRedirect[addOrRemove](this.webRequest_onBeforeRedirect, filter);
            if (true) {
              chrome.webRequest.onResponseStarted[addOrRemove](this.webRequest_onResponseStarted, filter);
            }
            chrome.webRequest.onCompleted[addOrRemove](this.webRequest_onCompleted, filter);
            chrome.webRequest.onErrorOccurred[addOrRemove](this.webRequest_onErrorOccurred, filter);
          }
        } catch (e) {
          log.SEVERE("8888", e);
        }
      };
      this.setListeners_webNavigation = function(addOrRemove) {
        try {
          if (typeof chrome.webNavigation == "undefined") {
            ...
            if (chrome.webNavigation.onCreatedNavigationTarget) {
              chrome.webNavigation.onCreatedNavigationTarget[addOrRemove](this.webNavigation_onCreatedNavigationTarget);
            } else {
              log.ERROR("chrome.webNavigation.onCreatedNavigationTarget undefined");
            }
            if (chrome.webNavigation.onBeforeNavigate) {
              chrome.webNavigation.onBeforeNavigate[addOrRemove](this.webNavigation_onBeforeNavigate);
            } else {
              log.ERROR("chrome.webNavigation.onBeforeNavigate undefined");
            }
            if (chrome.webNavigation.onCommitted) {
              chrome.webNavigation.onCommitted[addOrRemove](this.webNavigation_onCommitted);
            } else {
              log.ERROR("chrome.webNavigation.onCommitted undefined");
            }
            if (chrome.webNavigation.onDOMContentLoaded) {
              chrome.webNavigation.onDOMContentLoaded[addOrRemove](this.webNavigation_onDOMContentLoaded);
            } else {
              log.ERROR("chrome.webNavigation.onDOMContentLoaded undefined");
            }
            if (chrome.webNavigation.onCompleted) {
              chrome.webNavigation.onCompleted[addOrRemove](this.webNavigation_onCompleted);
            } else {
              log.ERROR("chrome.webNavigation.onCompleted undefined");
            }
            if (chrome.webNavigation.onErrorOccurred) {
              chrome.webNavigation.onErrorOccurred[addOrRemove](this.webNavigation_onErrorOccurred);
            } else {
              log.ERROR("chrome.webNavigation.onErrorOccurred undefined");
            }
            if (chrome.webNavigation.onTabReplaced) {
              chrome.webNavigation.onTabReplaced[addOrRemove](this.webNavigation_onTabRep);
            } else {
              log.ERROR("chrome.webNavigation.onTabReplaced undefined");
            }
            if (chrome.webNavigation.onHistoryStateUpdated) {
              chrome.webNavigation.onHistoryStateUpdated[addOrRemove](this.webNavigation_onHistoryStateUpdated);
            } else {
      ...
      this.setListeners_tabs = function(addOrRemove) {
        try {
          chrome.tabs.onCreated[addOrRemove](this.tabs_onCreated);
          chrome.tabs.onRemoved[addOrRemove](this.tabs_onRemoved);
          chrome.tabs.onUpdated[addOrRemove](this.tabs_onUpdated);
          chrome.tabs.onActivated[addOrRemove](this.tabs_onActivated);
          chrome.tabs.onReplaced[addOrRemove](this.tabs_onReplaced);
        } catch (e) {
          log.SEVERE("8889", e);
        }
      };
      this.addListeners = function() {
        try {
          this.setListeners_webRequest("addListener");
          this.setListeners_tabs("addListener");
          this.setListeners_webNavigation("addListener");
      ...
      this.removeListeners = function() {
        try {
          this.setListeners_webRequest("removeListener");
          this.setListeners_tabs("removeListener");
          this.setListeners_webNavigation("removeListener");
          chrome.windows.onFocusChanged.removeListener(this.windows_onFocusChanged);
          chrome.extension.onRequest.removeListener(this.extension_onRequest);
        } catch (e) {
          log.SEVERE("8844", e);
        }
      };
